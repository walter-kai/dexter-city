 ...
 */
var loginOrCreate = function (walletId, userDetails) { return __awaiter(void 0, void 0, Promise, function () {
    var users, existingUser, breadcrumb, newBreadcrumb, userPayload, newUser, updatedUser, error_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 6, , 7]);
                return [4 /*yield*/, user_service_1["default"].getUsersByWalletId([walletId])];
            case 1:
                users = _a.sent();
                existingUser = users && users[walletId] ? users[walletId] : null;
                breadcrumb = "Logging in user with walletId: " + walletId;
                newBreadcrumb = "loginOrCreate(" + walletId + "):" + breadcrumb;
