...
if (!telegramToken) {
  console.error("Telegram token not found. Please set the TELEGRAM_TOKEN environment variable.");
  process.exit(1);
}

// Use telegramToken here, as it's guaranteed to be a string
const bot: TelegramBot = new TelegramBot(telegramToken, { polling: false });
