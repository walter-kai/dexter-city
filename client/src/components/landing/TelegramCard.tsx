      ...
      {telegramCards.map((card) => (
        ...
        >
          <div className="flex flex-col items-center mb-2">
            <div className="h-20 flex items-center justify-center">{card.icon}</div>
          </div>
          <div className="flex-1 flex flex-col w-full">
            <h2 className={`text-2xl font-bold ${card.titleColor} mb-2 text-center`}>{card.title}</h2>
            <div className="text-[#e0e7ef] mb-4 text-center">{card.desc}</div>
