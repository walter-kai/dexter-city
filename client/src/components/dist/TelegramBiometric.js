...
exports.TelegramBiometric = void 0;
// Existing method to set header color
var Telegram_1 = require("../services/Telegram");
// New method to get biometric information
exports.TelegramBiometric = function () { return __awaiter(void 0, void 0, void 0, function () {
    var biometricInfo;
    return __generator(this, function (_a) {
        try {
            biometricInfo = Telegram_1["default"].biometricTrigger();
            console.log('Biometric Info:', biometricInfo); // Log the info or process it
            return [2 /*return*/, biometricInfo];
        }
        catch (error) {
